...
static const casadi_int casadi_s1[8] = {1, 4, 0, 0, 0, 1, 1, 0};

/* f_g_vect:(i0[4])->(o0[1x4,1nz]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_real a0;
  a0=1.4709974999999997e+002;
...
casadi_int main_f_g_vect(casadi_int argc, char* argv[]) {
  ...
  flag = f_g_vect(arg, res, iw, w+5, 0);
  if (flag) return flag;
  r = w+4;
